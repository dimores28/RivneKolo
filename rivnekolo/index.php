...
<head>
	...
	<link rel="stylesheet" href="css/style.min.css?_v=20231213131031">
...
<body>
	<div class="wrapper">
		...
		<main class="page" style="padding-top: 50px">
			<section class="hero">
					...
					<div class="ticker-bg">
						<div class="ticker-bg__content first-line">
							<div class="ticker-bg__row">
								<img class="ticker-bg__item" src="img/ticker/back_hero_1.svg" alt="ticker-bg" />
								<img class="ticker-bg__item" src="img/ticker/back_hero_1.svg" alt="ticker-bg" />
							</div>
							<div class="ticker-bg__row">
								<img class="ticker-bg__item" src="img/ticker/back_hero_1.svg" alt="ticker-bg" />
						...
						<div class="ticker-bg__content second-line">
							<div class="ticker-bg__row ticker-bg__row-reverse">
								<img class="ticker-bg__item" src="img/ticker/back_hero_2.svg" alt="ticker-bg" />
								<img class="ticker-bg__item" src="img/ticker/back_hero_2.svg" alt="ticker-bg" />
							</div>
							<div class="ticker-bg__row ticker-bg__row-reverse">
								<img class="ticker-bg__item" src="img/ticker/back_hero_2.svg" alt="ticker-bg" />
						...
						<div class="ticker-bg__content thrid-line">
							<div class="ticker-bg__row">
								<img class="ticker-bg__item" src="img/ticker/back_hero_3.svg" alt="ticker-bg" />
								<img class="ticker-bg__item" src="img/ticker/back_hero_3.svg" alt="ticker-bg" />
							</div>
							<div class="ticker-bg__row">
								<img class="ticker-bg__item" src="img/ticker/back_hero_3.svg" alt="ticker-bg" />
				...
				<img class="mobile-bg mobile-bg__1" src="img/hero/stick-bagel-1.svg" alt="background" />
				<img class="mobile-bg mobile-bg__2" src="img/hero/glazed-bagel.svg" alt="background" />
				<img class="mobile-bg mobile-bg__3" src="img/hero/stick-bagel.svg" alt="background" />
				<img class="mobile-bg mobile-bg__4" src="img/hero/bagel.svg" alt="background" />
				<img class="mobile-bg mobile-bg__5" src="img/hero/cake.svg" alt="background" />

				<div class="hero__container">
					<div class="hero__logo">
						<picture><source srcset="img/logo.webp" type="image/webp"><img class="hero__logo-img" src="img/logo.png" alt="logo" /></picture>
					</div>
					<div class="hero__wraper">
						<div class="hero__paralax">
							<div class="hero__paralax-wrap">
								<img class="stick-bagel-1 parallax-image" src="img/hero/stick-bagel-1.svg" alt="stick-bagel" />
								<img class="stick-bagel parallax-image" src="img/hero/stick-bagel.svg" alt="stick-bagel" />
								<img class="bagel parallax-image" src="img/hero/bagel.svg" alt="stick-bagel" />
								<img class="glazed-bagel parallax-image" src="img/hero/glazed-bagel.svg" alt="stick-bagel" />
								<img class="cake parallax-image" src="img/hero/cake.svg" alt="stick-bagel" />
								<img class="poppy-bagel parallax-image" src="img/hero/poppy-bagel.svg" alt="stick-bagel" />
							</div>
						</div>
						<div class="hero__content">
							...
							<picture><source srcset="img/hero/hero_person.webp" type="image/webp"><img class="hero__sticker-logo" src="img/hero/hero_person.png" alt="sticker-logo" /></picture>
							<picture><source srcset="img/hero/hero_sticker.webp" type="image/webp"><img class="hero__sticker" src="img/hero/hero_sticker.png" alt="" /></picture>
						</div>
					</div>
				</div>
			</section>
			<section class="products">
				<div class="products__container">
					...
					<div class="products__assortment assortment">
						<div class="assortment__item bagels" data-watch-threshold="1" data-watch data-popup="#popup">
							<div class="assortment__image-wrap">
								<picture><source srcset="img/products/flow_pack.webp" type="image/webp"><img src="img/products/flow_pack.png" class="assortment__product" width="622" height="651" alt="product img" /></picture>
								<picture><source srcset="img/products/Bagels1.webp" type="image/webp"><img src="img/products/Bagels1.png" class="assortment__bagels assortment__bagels_1" width="153" height="102" alt="Bagels" /></picture>
								<picture><source srcset="img/products/Bagels2.webp" type="image/webp"><img src="img/products/Bagels2.png" class="assortment__bagels assortment__bagels_2" width="202" height="200" alt="Bagels" /></picture>
								<picture><source srcset="img/products/Bagels3.webp" type="image/webp"><img src="img/products/Bagels3.png" class="assortment__bagels assortment__bagels_3" width="202" height="200" alt="Bagels" /></picture>
								<picture><source srcset="img/products/Bagels4.webp" type="image/webp"><img src="img/products/Bagels4.png" class="assortment__bagels assortment__bagels_4" width="153" height="102" alt="Bagels" /></picture>
								<picture><source srcset="img/products/Bagels5.webp" type="image/webp"><img src="img/products/Bagels5.png" class="assortment__bagels assortment__bagels_5" width="202" height="200" alt="Bagels" /></picture>
							</div>
							<div class="assortment__info assortment__info_1">
								<img src="img/products/spot1.svg" class="assortment__info-bg" width="381" height="378" alt="background img" />
								<h3 class="assortment__info-title">Малютки глазуровані</h3>
								<div class="assortment__info-weight">
									<span>300 г</span>
								</div>
								<div class="assortment__info-price">36 грн</div>
							</div>
						</div>
						...
						<div class="assortment__item bagels" data-watch-threshold="1" data-watch data-popup="#popup">
							...
							<div class="assortment__info assortment__info_2">
								<img src="img/products/spot2.svg" class="assortment__info-bg" width="381" height="378" alt="background img" />
								<h3 class="assortment__info-title">Малютки глазуровані</h3>
								<div class="assortment__info-weight">
									<span>300 г</span>
								</div>
						...
						<div class="assortment__item bagels" data-watch-threshold="1" data-watch data-popup="#popup">
							...
							<div class="assortment__info assortment__info_3">
								<img src="img/products/spot3.svg" class="assortment__info-bg" width="381" height="378" alt="background img" />
								<h3 class="assortment__info-title">Малютки глазуровані</h3>
								<div class="assortment__info-weight">
									<span>300 г</span>
								</div>
						...
						<div class="assortment__item nuts" data-watch-threshold="1" data-watch data-popup="#popup">
							<div class="assortment__image-wrap">
								<picture><source srcset="img/products/box.webp" type="image/webp"><img src="img/products/box.png" class="assortment__product" width="706" height="618" alt="product img" /></picture>
								<picture><source srcset="img/products/Nuts1.webp" type="image/webp"><img src="img/products/Nuts1.png" class="assortment__nuts assortment__nuts_1" width="167" height="131" alt="Nuts" /></picture>
								<picture><source srcset="img/products/Nuts2.webp" type="image/webp"><img src="img/products/Nuts2.png" class="assortment__nuts assortment__nuts_2" width="190" height="146" alt="Nuts" /></picture>
								<picture><source srcset="img/products/Nuts3.webp" type="image/webp"><img src="img/products/Nuts3.png" class="assortment__nuts assortment__nuts_3" width="207" height="213" alt="Nuts" /></picture>
								<picture><source srcset="img/products/Nuts4.webp" type="image/webp"><img src="img/products/Nuts4.png" class="assortment__nuts assortment__nuts_4" width="198" height="165" alt="Nuts" /></picture>
							</div>
							<div class="assortment__info assortment__info_4">
								<img src="img/products/spot4.svg" class="assortment__info-bg" width="456" height="403" alt="background img" />
								<p class="assortment__info-desc">зі згущеним молоком</p>
								<h3 class="assortment__info-title">Тістечко горішки</h3>
								<div class="assortment__info-weight">
									<span>1,2 кг</span>
								</div>
								<div class="assortment__info-price">36 грн</div>
					...
					<div class="social__content">
						...
						<div class="social__lincks">
							<div class="social-card social-card_inst" data-watch-threshold="1" data-watch>
								<a href="https://instagram.com/rivne_kolo?igshid=MzRlODBiNWFlZA==" class="social-card__link">
							...
							<div class="social-card social-card_fb" data-watch-threshold="1" data-watch>
								<a href="https://www.facebook.com/profile.php?id=61550944127906&sk=about" class="social-card__link">
							...
							<img src="img/social/hand.svg" class="social__hand" width="233" height="242" alt="hand" />
							<img src="img/social/shadow.svg" class="social__shadow" width="150" height="14" alt="shadow" />
						</div>
					</div>
				</div>
				...
				<div class="madein__container">
					...
					<div class="madein__block">
						...
						<div class="madein__illustration">
							<picture><source srcset="img/madein/city.webp" type="image/webp"><img src="img/madein/city.png" class="madein__img" width="753" height="1012" alt="illustration"></picture>
							<picture><source srcset="img/madein/madein.webp" type="image/webp"><img src="img/madein/madein.png" class="madein__sticker" width="393" height="229" alt="made in"></picture>
						</div>
					</div>
				</div>
					...
					<div class="madein__slider swiper">
						<div class="madein__wrapper swiper-wrapper">
							<div class="madein__slide swiper-slide">
								<picture><source srcset="img/madein/slide1.webp" type="image/webp"><img src="img/madein/slide1.jpg" width="680" height="820" alt="slide images"></picture>
							</div>
							<div class="madein__slide swiper-slide">
								<picture><source srcset="img/madein/slide2.webp" type="image/webp"><img src="img/madein/slide2.jpg" width="680" height="820" alt="slide images"></picture>
							</div>
							<div class="madein__slide swiper-slide">
								<picture><source srcset="img/madein/slide3.webp" type="image/webp"><img src="img/madein/slide3.jpg" width="680" height="820" alt="slide images"></picture>
							</div>
							<div class="madein__slide swiper-slide">
								<picture><source srcset="img/madein/slide4.webp" type="image/webp"><img src="img/madein/slide4.jpg" width="680" height="820" alt="slide images"></picture>
							</div>
							<div class="madein__slide swiper-slide">
								<picture><source srcset="img/madein/slide5.webp" type="image/webp"><img src="img/madein/slide5.jpg" width="680" height="820" alt="slide images"></picture>
							</div>
							<div class="madein__slide swiper-slide">
								<picture><source srcset="img/madein/slide6.webp" type="image/webp"><img src="img/madein/slide6.jpg" width="680" height="820" alt="slide images"></picture>
							</div>
							<div class="madein__slide swiper-slide">
								<picture><source srcset="img/madein/slide7.webp" type="image/webp"><img src="img/madein/slide7.jpg" width="680" height="820" alt="slide images"></picture>
							</div>
							<div class="madein__slide swiper-slide">
								<picture><source srcset="img/madein/slide8.webp" type="image/webp"><img src="img/madein/slide8.jpg" width="680" height="820" alt="slide images"></picture>
							</div>
						</div>
					</div>
				</div>
				...
				<div class="about__container">
					...
					<div class="about__content">
						<div class="about__scene about__scene_1 scene-text">
							...
							<p class="row_2">
								<span>фішкою
									<img src="img/about/chip.svg" width="56" height="70" alt="Chip" /></span>
								є комфортні
							</p>
						...
						<div class="about__scene about__scene_2 scene-text">
							...
							<p class="row_4">
								<i>хоче</i>
								з нами дружити
								<span><img src="img/about/hands.svg" width="79" height="75" alt="hands" /></span>,
							</p>
							<p class="row_8">розвиватися <i>та</i></p>
							<p class="row_6">
								<i>та</i>
								зростати
								<span><img src="img/about/rocket.svg" width="97" height="84" alt="rocket" /></span>
							</p>
						</div>
						...
						<div class="about__scene about__scene_5">
							...
							<div class="advanteges">
								<div class="advanteges__item advanteges__item_1">
									<picture><source srcset="img/about/atv1.webp" type="image/webp"><img src="img/about/atv1.png" width="287" height="300" class="advanteges__img" alt="advanteges" /></picture>
								...
								<div class="advanteges__item advanteges__item_2">
									...
									<picture><source srcset="img/about/atv2.webp" type="image/webp"><img src="img/about/atv2.png" width="251" height="251" class="advanteges__img" alt="advanteges" /></picture>
								</div>
								<div class="advanteges__item advanteges__item_3">
									<picture><source srcset="img/about/atv3.webp" type="image/webp"><img src="img/about/atv3.png" width="299" height="232" class="advanteges__img" alt="advanteges" /></picture>
									<p class="advanteges__desc body_7">
										власна логістика, швидка доставка
									</p>
								</div>
								<div class="advanteges__item advanteges__item_4">
									<picture><source srcset="img/about/atv4.webp" type="image/webp"><img src="img/about/atv4.png" width="277" height="228" class="advanteges__img" alt="advanteges" /></picture>
									<p class="advanteges__desc body_7">власний креативний R&D відділ</p>
								</div>
								<div class="advanteges__item advanteges__item_5">
									<picture><source srcset="img/about/atv5.webp" type="image/webp"><img src="img/about/atv5.png" width="288" height="235" class="advanteges__img" alt="advanteges" /></picture>
									<p class="advanteges__desc body_7">
						...
						<div class="about__scene about__scene_4 scene-text">
							<p class="row_1">
								телефонуй
								<span>
									<img src="img/about/phone.svg" width="79" height="85" alt="phone" />
								</span>
								<i>та</i>
							</p>
					...
					<div class="about__bagel" data-da=".about,768,0">
						<!-- <picture><source srcset="img/about/frame.webp" type="image/webp"><img src="img/about/frame.png" alt="bagel" /></picture> -->
				...
				<div class="feedback__wrap">
					<div class="feedback__container">
						<div class="form__success">
							...
							<picture><source srcset="img/feedback/ok_mark.webp" type="image/webp"><img class="form__success-mark" src="img/feedback/ok_mark.png" alt="ok-mark" /></picture>
						</div>
						<picture><source srcset="img/feedback/message.webp" type="image/webp"><img class="img__sticker img__sticker-1" src="img/feedback/message.png" alt="message-mark" /></picture>
						<picture><source srcset="img/feedback/question.webp" type="image/webp"><img class="img__sticker img__sticker-2" src="img/feedback/question.png" alt="question-mark" /></picture>
						...
						<form class="feedback__form form">
							<div class="form__wrap">
								...
								<label class="form__lable label-name" for="">
				...
				<section class="cooperation">
					<div class="cooperation__container">
						...
						<div class="cooperation__img">
							<picture><source srcset="img/cooperation/cooperation_img.webp" type="image/webp"><img src="img/cooperation/cooperation_img.png" alt="logo-sticker" /></picture>
						</div>
					</div>
				</section>
				<section class="offer">
							...
							<div class="instagram__slide swiper-slide slide">
								<div class="slide__head">
									<div class="slide__head-wrap">
										<img class="slide__logo" src="img/instagram/logo.svg" alt="logo" />
										<h5 class="slide__heading title_5">Rivne Kolo</h5>
										<p class="slide__data date">09 Серп 2023</p>
									</div>

									<img class="slide__icon" src="img/instagram/icon.svg" alt="instagram" />
								</div>
								<div class="slide__img">
									<picture><source srcset="img/instagram/post-img.webp" type="image/webp"><img src="img/instagram/post-img.png" alt="post" /></picture>
								</div>
							</div>
			...
			<div class="footer__container">
				<div class="footer__content">
					<a href="/" class="footer__logo">
						<picture><source srcset="img/logo.webp" type="image/webp"><img src="img/logo.png" width="368" height="368" alt="logo"></picture>
					</a>
					...
					<div class="footer__contacts">
						...
						<div class="footer__phones">
							<a href="tel:+380630000000" class="footer__linck">
								+38(063) 000 00 00
							</a>
							<br>
							<a href="tel:+380960000000" class="footer__linck">
								+38(096) 000 00 00
							</a>
							<br>
							<a href="mailto:example@mail.com" class="footer__linck">
								example@mail.com
							</a>
						</div>
						<a href="https://maps.app.goo.gl/6htCFmpaw5VM6AgQ9" class="footer__linck footer__linck_addr" target="_blank">
							Україна, м.Рівне, вул.Старицького, 45.
						</a>
					</div>
				</div>
			...
			<style>
				...
				*:after {
				...
				.fls-preloader__counter {
					width: 540px;
					height: 540px;
					background: url(img/preloader/sprites.png) center no-repeat;
			...
			<script>
				...
				<div class="fls-preloader">
					<div class="fls-preloader__body">
						...
						<img src="img/preloader/kolo.gif" class="fls-preloader__gif" alt="">
					</div>
		...
		<div class="popup__wrapper">
			<div class="popup__content">
				<div class="popup__container">
					...
					<div class="product bagels _watcher-view-popup">
					...
					<div class="product__info">
						<h3 class="product__info-title heading_3">Малютки глазуровані</h3>

						<p class="product__info-text body_5">
							Бублики малютка - смачна та корисна страва навіть для найменших
							гурманів. Мають нейтральний приємний смак. М'які, пухкі і легкі для
							пережовування, зручно їсти. Можна зїсти їх окремо або посмакувати їх
							з додатками, такими як пюре з фруктів чи йогурт, для
							різноманітності.
						</p>
              ...
              /> -->
						...
						<!-- <button class="product__info-btn btn button">
            <span>Замовити</span>
          </button> -->
								...
								<div class="order__wrap">
									...
									<form class="order-form">
										...
										<div class="order-form__wrap">
											<label class="order-form__lable name-lable" for="">
												<span class="order-form__placeholder">Ваше ім’я</span>
												<input class="order-form__input" name="yourName" type="text" aria-label="your name" id="userName" />
											</label>

											<label class="order-form__lable phone-lable" for="">
												<span class="order-form__placeholder">Номер телефону</span>
												<input class="order-form__input" name="yourPhone" type="text" aria-label="your phone" id="userPhone" />
											</label>
										</div>
										<div class="order-form__wrap">
											<label class="order-form__lable amount-lable" for="">
												<input type="number" class="order-form__amount" name="amount" min="1" max="1000" placeholder="0" />
											</label>
	...
	<script src="js/app.min.js?_v=20231213131031"></script>
</body>
